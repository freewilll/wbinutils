...
#define strmap_ordered_foreach(map, it) \
    for (StrMapOrderedIterator it = strmap_ordered_iterator(map); \
        !strmap_ordered_iterator_finished(&it); \
        strmap_ordered_iterator_next(&it))
