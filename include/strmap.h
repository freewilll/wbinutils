...
void *strmap_get(StrMap *strmap, const char *key);
void strmap_put(StrMap *strmap, const char *key, void *value);
void strmap_delete(StrMap *strmap, const char *key);
...
const char *strmap_iterator_key(StrMapIterator *iterator);
